 ...
 *         Class that contains the model for the settings
 */
public class Settings
{
    ...
    /**
     * Constructor that identifies the settings name and build a object according to it
     *
    ...
    /**
     * Getter method that returns the created object
     *
