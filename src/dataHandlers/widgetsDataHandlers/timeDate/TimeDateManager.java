package dataHandlers.widgetsDataHandlers.timeDate;
...
public class TimeDateManager extends Observable
{
    ...
    private static DateTimeFormatter SHORT_TIME_FORMATTER_SEC = DateTimeFormatter.ofPattern("HH:mm:ss");
    ...
    private void notifyTimeChanged()
    {
        ...
        if (LocalTime.now().format(SHORT_TIME_FORMATTER_SEC).endsWith("10") || LocalTime.now().format(SHORT_TIME_FORMATTER_SEC).endsWith("40")) {
            setChanged();
